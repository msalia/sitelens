...
-- site origin so points, grid, and overlays align with true-north context
-- (terrain, OSM buildings). 0 = no correction (the default for properly-tied
-- projects whose stored projected coordinates are already real-world).
